...
public class RentedBusDetailModel extends BaseModel
{
    public RentedBusDetail getRentedBusDetail()
    {
        ArrayList<String> slideImages = new ArrayList<>();
        slideImages.add("http://www.tyncar.com/uploads/allimg/130706/1-130F6150500A4.jpg");
        slideImages.add("http://i2.dd-img.com/upload/2016/1020/1476949904699.jpg");
        slideImages.add("http://ww1.sinaimg.cn/bmiddle/a5b6813djw1ec0bfgjwn9j20c8085q43.jpg");
        ...
        params.put("灯光类型", "卤素");
        return new RentedBusDetail(params, slideImages);
    }
}
